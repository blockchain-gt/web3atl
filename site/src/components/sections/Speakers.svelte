...
<div class="bg-white">
	<section class="p-0 lg:p-8">
		<div class="flex flex-col text-black gap-10 lg:gap-32">
			<div class="flex flex-col lg:flex-row">
				<div class="flex-1 flex justify-center">
					<img src="./Build.jpg" alt="Web 3.0 ATL Hackathon">
				</div>
			...
			<div class="flex flex-col lg:flex-row-reverse">
				<div class="flex-1 flex justify-center">
					<img src="./Inform.jpg" alt="Web 3.0 ATL Hackathon">
				</div>
				<div class="lg:flex-1 p-8 lg:pl-0 lg:pt-0 text-2xl">
					<h2 class="mt-5">Inform</h2>
					<p>
						do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in.
					</p>
				</div>
			</div>
			<div class="flex flex-col lg:flex-row">
				<div class="flex-1 flex justify-center">
					<img src="./Advance.jpg" alt="Web 3.0 ATL Hackathon">
				</div>
				<div class="lg:flex-1 p-8 lg:pt-0 text-2xl">
					<h2 class="">Advance</h2>
					<p>
		...
		<span class="flex flex-col items-baseline text-black p-8 lg:p-0">
			...
			<h3 class="w-full my-4 text-center lg:text-left">Announcing speakers at the end of August</h3>
			<div class="mx-auto lg:mx-0 my-4">
			<a
				class="px-8 py-3 inline-block rounded-md text-white bg-primary shadow-hover-lg"
				href="#speakers">Speaker Interest Form</a
			>
			</div>
		</span>
