<script lang="ts">
	import type { PeopleSection, SponsorsSection } from '$lib/types/components';
	import type { Sponsor } from '$lib/types/models';

	export let section: PeopleSection;
...
<section class="bg-white text-black flex flex-col lg:flex-row gap-5 lg:justify-between">
