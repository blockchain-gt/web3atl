<script lang="ts" context="module">
	...
	export async function load({ fetch }) {
		...
		json.data.page.components = [components[0], { "__typename": "PeopleSection", "SpeakerSection" : components[1], "SponsorSection" : components[2], "TicketsSection" : components[3] }, components[4]]
